...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Sweetalert2 = t() }(this, (function() {
    ...
    const t = e => { const t = {}; for (const n in e) t[e[n]] = "swal2-" + e[n]; return t },
        ...
        O = () => {
            ...
            return (e => { const t = []; for (let n = 0; n < e.length; n++) - 1 === t.indexOf(e[n]) && t.push(e[n]); return t })(e.concat(t)).filter((e => J(e)))
        },
        ...
        q = (e, t, i) => {
            if (((e, t) => { Array.from(e.classList).forEach((i => { Object.values(n).includes(i) || Object.values(o).includes(i) || Object.values(t.showClass).includes(i) || e.classList.remove(i) })) })(e, t), t.customClass && t.customClass[i]) {
        ...
        se = e => {
            const t = (() => { const e = g(); return !!e && (e.remove(), U([document.documentElement, document.body], [n["no-backdrop"], n["toast-shown"], n["has-column"]]), !0) })();
            ...
            })(e), (e => { "rtl" === window.getComputedStyle(e).direction && R(g(), n.rtl) })(i), (() => {
                const e = b(),
                    t = _(e, n.input),
                    o = _(e, n.file),
    ...
    function de(e, t, o) { Z(e, o[`show${s(t)}Button`], "inline-block"), I(e, o[`${t}ButtonText`]), e.setAttribute("aria-label", o[`${t}ButtonAriaLabel`]), e.className = n[t], q(e, o, `${t}Button`), R(e, o[`${t}ButtonClass`]) }
    const pe = (e, t) => {
        const o = g();
        o && (! function(e, t) { "string" == typeof t ? e.style.background = t : t || R([document.documentElement, document.body], n["no-backdrop"]) }(o, t.backdrop), function(e, t) { t in n ? R(e, n[t]) : (r('The "position" parameter is not valid, defaulting to "center"'), R(e, n.center)) }(o, t.position), function(e, t) {
    ...
    const Me = () => B() && B().click(),
        ...
        Ue = e => {
            ...
            for (let e = 0; e < $().children.length; e++) { if (s = s[i], !s) return; if (s instanceof HTMLButtonElement && J(s)) break }
            s instanceof HTMLButtonElement && s.focus()
        },
        _e = (e, t, n) => { u(t.allowEscapeKey) && (e.preventDefault(), n(He.esc)) };
    var We = { swalPromiseResolve: new WeakMap, swalPromiseReject: new WeakMap };
    const ze = () => { Array.from(document.body.children).forEach((e => { e.hasAttribute("data-previous-aria-hidden") ? (e.setAttribute("aria-hidden", e.getAttribute("data-previous-aria-hidden")), e.removeAttribute("data-previous-aria-hidden")) : e.removeAttribute("aria-hidden") })) },
        Ke = () => {
    ...
    const nt = t => { t.isAwaitingPromise() && (e.awaitingPromise.delete(t), e.innerParams.get(t) || t._destroy()) },
    ...
    function lt(e, t) {
        if (e)
            if ("radio" === e.type) { const n = e.parentNode.parentNode.querySelectorAll("input"); for (let e = 0; e < n.length; e++) n[e].disabled = t } else e.disabled = t
    }
    const ct = { title: "", titleText: "", text: "", html: "", footer: "", icon: void 0, iconColor: void 0, iconHtml: void 0, template: void 0, toast: !1, showClass: { popup: "swal2-show", backdrop: "swal2-backdrop-show", icon: "swal2-icon-show" }, hideClass: { popup: "swal2-hide", backdrop: "swal2-backdrop-hide", icon: "swal2-icon-hide" }, customClass: {}, target: "body", color: void 0, backdrop: !0, heightAuto: !0, allowOutsideClick: !0, allowEscapeKey: !0, allowEnterKey: !0, stopKeydownPropagation: !0, keydownListenerCapture: !1, showConfirmButton: !0, showDenyButton: !1, showCancelButton: !1, preConfirm: void 0, preDeny: void 0, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: void 0, denyButtonText: "No", denyButtonAriaLabel: "", denyButtonColor: void 0, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: void 0, buttonsStyling: !0, reverseButtons: !1, focusConfirm: !0, focusDeny: !1, focusCancel: !1, returnFocus: !0, showCloseButton: !1, closeButtonHtml: "&times;", closeButtonAriaLabel: "Close this dialog", loaderHtml: "", showLoaderOnConfirm: !1, showLoaderOnDeny: !1, imageUrl: void 0, imageWidth: void 0, imageHeight: void 0, imageAlt: "", timer: void 0, timerProgressBar: !1, width: void 0, padding: void 0, background: void 0, input: void 0, inputPlaceholder: "", inputLabel: "", inputValue: "", inputOptions: {}, inputAutoFocus: !0, inputAutoTrim: !0, inputAttributes: {}, inputValidator: void 0, returnInputValueOnDeny: !1, validationMessage: void 0, grow: !1, position: "center", progressSteps: [], currentProgressStep: void 0, progressStepsDistance: void 0, willOpen: void 0, didOpen: void 0, didRender: void 0, willClose: void 0, didClose: void 0, didDestroy: void 0, scrollbarPadding: !0 },
        ...
        yt = e => { ht(e) && c(e, ht(e)) };
    const wt = e => { const t = {}; return Object.keys(e).forEach((n => { gt(n) ? t[n] = e[n] : r(`Invalid parameter to update: ${n}`) })), t };
    const vt = e => { Ct(e), delete e.params, delete ee.keydownHandler, delete ee.keydownTarget, delete ee.currentInstance },
        Ct = t => { t.isAwaitingPromise() ? (At(e, t), e.awaitingPromise.set(t, !0)) : (At(We, t), At(e, t)) },
        At = (e, t) => { for (const n in e) e[n].delete(t) };
    var kt = Object.freeze({
        ...
        close: et,
        isAwaitingPromise: function() { return !!e.awaitingPromise.get(this) },
        ...
        closeModal: et,
        closeToast: et,
        enableButtons: function() { at(this, ["confirmButton", "denyButton", "cancelButton"], !1) },
        disableButtons: function() { at(this, ["confirmButton", "denyButton", "cancelButton"], !0) },
        enableInput: function() { lt(this.getInput(), !1) },
        disableInput: function() { lt(this.getInput(), !0) },
    ...
    const Bt = e => {
        ...
        It = (t, n) => {
            ...
            if (o.showLoaderOnDeny && Bt(P()), o.preDeny) {
                ...
                Promise.resolve().then((() => p(o.preDeny(n, o.validationMessage)))).then((e => {!1 === e ? (t.hideLoading(), nt(t)) : t.close({ isDenied: !0, value: void 0 === e ? n : e }) })).catch((e => qt(t || void 0, e)))
        ...
        Vt = (t, n) => {
            ...
            if (o.showLoaderOnConfirm && Bt(), o.preConfirm) {
                ...
                Promise.resolve().then((() => p(o.preConfirm(n, o.validationMessage)))).then((e => { J(k()) || !1 === e ? (t.hideLoading(), nt(t)) : Dt(t, void 0 === e ? n : e) })).catch((e => qt(t || void 0, e)))
            } else Dt(t, n)
        },
        Nt = (t, n, o) => {
            n.popup.onclick = () => {
    ...
    let Rt = !1;
    const Ut = e => { e.popup.onmousedown = () => { e.container.onmouseup = function(t) { e.container.onmouseup = void 0, t.target === e.container && (Rt = !0) } } },
    ...
    const Kt = () => {
        ...
        Yt = () => { if (ee.timeout) { const e = ee.timeout.start(); return Q(e), e } };
    let Zt = !1;
    const Jt = {};
    const Xt = e => {
        for (let t = e.target; t && t !== document; t = t.parentNode)
            for (const e in Jt) { const n = t.getAttribute(e); if (n) return void Jt[e].fire({ template: n }) }
    };
    var Gt = Object.freeze({
        ...
        argsToParams: e => { const t = {}; return "object" != typeof e[0] || zt(e[0]) ? ["title", "html", "icon"].forEach(((n, o) => { const i = e[o]; "string" == typeof i || zt(i) ? t[n] = i : void 0 !== i && a(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`) })) : Object.assign(t, e[0]), t },
        getContainer: g,
        getPopup: b,
        getTitle: w,
        getHtmlContainer: v,
        ...
        fire: function() { const e = this; for (var t = arguments.length, n = new Array(t), o = 0; o < t; o++) n[o] = arguments[o]; return new e(...n) },
        mixin: function(e) { return class extends(this) { _main(t, n) { return super._main(t, Object.assign({}, e, n)) } } },
        showLoading: Bt,
        enableLoading: Bt,
        getTimerLeft: () => ee.timeout && ee.timeout.getTimerLeft(),
        stopTimer: Kt,
        resumeTimer: Yt,
        toggleTimer: () => { const e = ee.timeout; return e && (e.running ? Kt() : Yt()) },
        increaseTimer: e => { if (ee.timeout) { const t = ee.timeout.increase(e); return Q(t, !0), t } },
    ...
    const en = ["swal-title", "swal-html", "swal-footer"],
        ...
        gn = (e, t, o) => {
            ...
            })(), t && "hidden" !== o && Ge(), setTimeout((() => { e.scrollTop = 0 }))
        },
        hn = (e, t, o) => { R(e, o.showClass.backdrop), t.style.setProperty("opacity", "0", "important"), z(t, "grid"), setTimeout((() => { R(t, o.showClass.popup), t.style.removeProperty("opacity") }), 10), R([document.documentElement, document.body], n.shown), o.heightAuto && o.backdrop && !o.toast && R([document.documentElement, document.body], n["height-auto"]) };
    var fn = { email: (e, t) => /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address"), url: (e, t) => /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL") };

    function bn(e) {
        ! function(e) { e.inputValidator || Object.keys(fn).forEach((t => { e.input === t && (e.inputValidator = fn[t]) })) }(e), e.showLoaderOnConfirm && !e.preConfirm && r("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
            function(e) {
    ...
    class wn {
        ...
        _main(t) {
            ...
            (e => {!1 === e.backdrop && e.allowOutsideClick && r('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'); for (const t in e) ft(t), e.toast && bt(t), yt(t) })(Object.assign({}, n, t)), ee.currentInstance && (ee.currentInstance._destroy(), j() && ze()), ee.currentInstance = yn;
            const o = Cn(t, n);
        ...
        then(t) { return e.promise.get(this).then(t) } finally(t) { return e.promise.get(this).finally(t) }
    }
    const vn = (t, n, o) => new Promise(((i, s) => {
            const r = e => { t.close({ isDismissed: !0, dismiss: e }) };
        ...
        An = t => { const n = { popup: b(), container: g(), actions: $(), confirmButton: B(), denyButton: P(), cancelButton: E(), loader: x(), closeButton: L(), validationMessage: k(), progressSteps: A() }; return e.domCache.set(t, n), n },
        kn = (e, t, n) => {
            const o = S();
        ...
        xn = () => { document.activeElement instanceof HTMLElement && "function" == typeof document.activeElement.blur && document.activeElement.blur() };
    ...
    Object.assign(wn.prototype, kt), Object.assign(wn, Gt), Object.keys(kt).forEach((e => { wn[e] = function() { if (yn) return yn[e](...arguments) } })), wn.DismissReason = He, wn.version = "11.7.0";
    const En = wn;
